            ...
            <div style={{
                ...
                <div className="container d-flex justify-content-center">
                    <div className="w-50 bg-black text-white p-5 fw-medium fs-5" style={{textAlign: "justify"}}>
                        Feel free to reach out to me with any inquiries about my studies or for collaboration on
                        projects. You can connect with me and explore more about my academic journey and professional
                        endeavors through the following links. I'm open to discussions, networking, and assisting with
                    ...
                    <div className="row w-100">
                        ...
                        <div className="col-8  m-3 p-0 rounded-3 w-100 d-flex align-items-center align-content-center"
                            ...
                            <div
                                ...
                                <h5><a href="/contact" className="text-white">CONTACT</a></h5>
                            </div>
                        </div>
                        <div className="col-2"></div>
                    </div>
